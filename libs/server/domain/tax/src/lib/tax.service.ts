...
import { Balance, Order, TaxRecord, TransactionRecord, TransactionType } from './base';
...
export class TaxService {
  ...
  private _splitByTransactionsPeriods(
    ...
    return transactions.reduce(
      ...
      [[], [], []] as [TransactionRecord[], TransactionRecord[], TransactionRecord[]],
    );
  }
  ...
  private _splitByTransactionsTypes(
    ...
    return transactions.reduce(
      ...
      [[], []] as [TransactionRecord[], TransactionRecord[]],
    );
  }
